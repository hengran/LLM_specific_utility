...
from dataset import PointPerformanceEncodeDataset
...
if __name__ == '__main__':
    ...
    if "Qwen2.5-7b-instruct" in model_args.model_name_or_path:
        num_gpu = 7
    else:
        num_gpu = 8
    llm = LLM(
    ...
    dataset = PointPerformanceEncodeDataset(data_args, tokenizer)
